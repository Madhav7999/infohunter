...
1. Clone the repository:
   git clone https://github.com/madhavmeesala/InfoHunter.git
...
Madhav Meesala is a Software Engineer with over 4 years of experience building scalable full-stack and distributed systems. With a background in financial services and digital payments, he specializes in Python, Java, and cloud-native development. This project is maintained to provide a robust, professional-grade OSINT toolset for security researchers and developers seeking high-performance intelligence gathering solutions.